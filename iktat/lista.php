...
if (isset($_POST["lista"])){
    ...
    $levelek = $db->lista($uid, $dattol, $datig);
...
<form action="#" method="POST">
    ...
    <div class="form-group">
        <label for="datum">Dátumtól</label>
        <input type="date" name="datumtol" class="form-control" id="datumtol" required>
    </div>
  
    <!-- Dátumig -->
    <div class="form-group">
        <label for="datum">Dátumig</label>
        <input type="date" name="datumig" class="form-control" id="datumig" required>
    </div>
  

    <!-- OK gomb -->
    <button type="submit" name="lista" id="lista" class="button button-success">Lista</button>
</form>
<!-- Eredmény kiírása -->
